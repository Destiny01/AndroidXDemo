package com.jinnuojiayin.recorddemo.util.aac;
...
public class MediaUtils {
    ...
    /**
     * @param voiceFiles 需要合成的相同配置参数的aac语音片段
     * @return 返回最终生成的语音判断
     * 注意:amr格式的头文件为6个字节的长度,aac格式的头文件为7或9个字节的长度
     */

    public static String composeVoiceFile(Activity activity, List<String> voiceFiles, String tag) {
        String endFileUrl = getNewVoiceFileUrl(tag);
        try {
